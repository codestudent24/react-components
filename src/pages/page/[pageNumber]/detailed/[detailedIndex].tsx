...
import getStarships, { getStarshipByIndex } from "@/utils/api";
...
export default function Detailed({ propsData, item }: InferGetServerSidePropsType<typeof getServerSideProps>) {
  return (
    <Layout>
